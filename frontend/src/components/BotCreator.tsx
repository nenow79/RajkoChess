...
const LABELS: Record<BotStyleKey, string> = { aggression: "Agresja", tacticality: "Taktyka", risk: "Ryzyko", materialism: "Materializm", simplification: "Uproszczenia" };
...
export default function BotCreator({ editingBot, onSaved, onClose }: BotCreatorProps) {
  ...
  const addOpening = (opening: OpeningSearchResult) => {
    if (!draft) return;
